  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-gray-950 to-black text-white p-8">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold mb-2">AI Game Music / Soundscape Generator</h1>
        <p className="text-gray-400 mb-8">AI Game Music / Soundscape Generator & Mood Tracker</p>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            ...
            style={{ backgroundColor: "hsl(240deg, 70%, 60%)" }}
          >
